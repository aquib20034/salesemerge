...
(function ($) {
    $.fn.imageUploader = function (options) {
        let defaults = { preloaded: [], imagesInputName: "text", preloadedInputName: "preloaded", label: "Drag & Drop files here or click to browse" };
        let plugin = this;
        plugin.settings = {};
        ...
        let createImg = function (src, id, txt) {
            // let $container = $("<div>test", { class: "uploaded-image" }),
            let $container = $("<div>test", { class: "uploaded-image" }),
                $img = $("<label>", { text: txt,  class: "form-control", style: "color:white"}).appendTo($container),
        ...
        let setPreview = function ($container, files) {
            ...
            $(files).each(function (i, file) {
                ...
                var indx = dataTransfer.items.length - 1;
                var name = dataTransfer.files[indx].name;
                $uploadedContainer.append(createImg(URL.createObjectURL(file),indx, name));
