        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <!--begin::Form-->
                    {!! Form::open(array('route' => 'purchases.store','method'=>'POST','id'=>'form','enctype'=>'multipart/form-data')) !!}
                        ...
                        <div class="card-body">
                            ...
                            <div class=" row">
                                <!-- <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        {!! Html::decode(Form::label('payment_type_id','Payment Type ')) !!}
                                        {!! Form::select('payment_type_id', $payment_types,null, array('class' => 'form-control')) !!}
                                        @if ($errors->has('payment_type_id'))  
                                            {!! "<span class='span_danger'>". $errors->first('payment_type_id')."</span>"!!} 
                                        @endif
                                    </div>
                                </div> -->
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        {!! Form::number('bilty_amount', 0, array('placeholder' => 'Enter bilty (Karaya)','class' => 'form-control','onchange'=>'calc_value()')) !!}
                            ...
                            <div class=" row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        {!! Form::date('purchase_date', date('Y-m-d'), array('placeholder' => 'Enter purchase','class' => 'form-control')) !!}
