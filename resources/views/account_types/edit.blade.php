                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <a  href="{{ route('account_types.index') }}" class="btn btn-primary btn-xs ml-auto">
                    ...
                    <!--begin::Form-->
                        {!! Form::model($data, ['method' => 'PATCH','id'=>'form','enctype'=>'multipart/form-data','route' => ['account_types.update', $data->id]]) !!}
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                {!! Html::decode(Form::label('name','Account type<span class="text-danger">*</span>')) !!}
                                                {{ Form::text('name', null, array('placeholder' => 'Enter account type','class' => 'form-control','autofocus' => ''  )) }}
                                                @if ($errors->has('name'))  
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                {!! Form::select('parent_id', [0=>"--No parent--"]+$account_types,$data->parent_id, array('class' => 'form-control')) !!}
