        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <!--begin::Form-->
                        {!! Form::open(array('route' => 'account_types.store','method'=>'POST','id'=>'form','enctype'=>'multipart/form-data')) !!}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            {!! Form::select('parent_id', [0=>"--No parent--"]+$account_types,[], array('class' => 'form-control')) !!}
