                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $("#itemTable tr:last").after("<tr id='row_itemTable"+$rowno+"'>"+
                                ...
                                "</td>"+
                                "<td> " +
                                '<input type="text" id="unit[]" name="unit[]" value ="'+data.unit.name+'" class="form-control" readonly>'+
                                "</td>"+
                                "<td> " +
                        ...
                        <div class="card-body">
                            ...
                            <div class=" row">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        {!! Html::decode(Form::label('order_no',' Customer Order No: ')) !!}
                                                ...
                                                <?php if(isset($selected_items)){
                                                    ...
                                                    <script type="text/javascript">
                                                        ...
                                                        $("#itemTable tr:last").after("<tr id='row_itemTable"+$rowno+"'>"+
                                                            ...
                                                            "</td>"+
                                                            "<td> " +
                                                                '<input type="text" id="unit[]" name="unit[]" value ="{{$value->unit_name}}" class="form-control" readonly>'+
                                                            "</td>"+
                                                            "<td> " +
