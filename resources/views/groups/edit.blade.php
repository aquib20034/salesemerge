                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <a  href="{{ route('groups.index') }}" class="btn btn-primary btn-xs ml-auto">
                    ...
                    <!--begin::Form-->
                        {!! Form::model($data, ['method' => 'PATCH','id'=>'form','enctype'=>'multipart/form-data','route' => ['groups.update', $data->id]]) !!}
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                {!! Html::decode(Form::label('name','Group name <span class="text-danger">*</span>')) !!}
                                                {{ Form::text('name', null, array('placeholder' => 'Enter group name','class' => 'form-control','autofocus' => ''  )) }}
                                                @if ($errors->has('name'))  
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                {!! Form::select('parent_id', [0=>"--No parent--"]+$groups,$data->parent_id, array('class' => 'form-control')) !!}
