    ...
    public function store(Request $request)
    {
        ...
        if($request['entity']=='company'){
            ...
            $rec            = DB::table('customer_has_transactions')
                                ...
                                ->leftjoin('sells', 'sells.id', '=', 'customer_has_transactions.sell_id')
                                
                                ->select(
                                        'customer_has_transactions.customer_id',
                                        'customers.name as name',
                                        'customer_has_transactions.credit',
                                        'customer_has_transactions.debit',
                                        'customer_has_transactions.sell_id as bill_id',
